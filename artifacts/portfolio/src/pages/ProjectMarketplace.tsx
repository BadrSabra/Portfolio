...
import { ExternalLink, CheckCircle2, ArrowRight, ArrowLeft } from "lucide-react";
import { motion } from "framer-motion";
import NotFound from "./not-found";

export default function ProjectMarketplace() {
  const project = projects.find(p => p.slug === "marketplace");
      ...
      <main className="flex-1 pt-24 pb-16">
        <article className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          >
            ...
            {/* Navigation */}
            <div className="pt-12 border-t border-border mt-24 flex justify-between items-center">
              <Link 
                href="/projects/tutorrl"
              ...
              >
                ...
                <span className="text-xl md:text-2xl font-heading font-bold flex items-center gap-2 group-hover:text-primary transition-colors">
                  <ArrowLeft className="w-5 h-5 md:w-6 md:h-6 group-hover:-translate-x-2 transition-transform" /> TutorRL 
                </span>
              </Link>
              <Link 
                href="/projects/system-core"
