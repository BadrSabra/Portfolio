...
export default function ProjectTutorRL() {
  const project = projects.find(p => p.slug === "tutorrl");
            ...
            <div className="pt-12 border-t border-border mt-24">
              ...
              >
                ...
                <span className="text-2xl font-heading font-bold flex items-center gap-2 group-hover:text-primary transition-colors">
                  Mit Gaber <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform" />
                </span>
              </Link>
            </div>
          </motion.div>
